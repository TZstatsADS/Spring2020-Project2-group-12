...
```{r}
# load lyrics data
load('~/Documents/Spring2020-Project2-group-12/output/df.RData') 
```
...
corpus <- VCorpus(VectorSource(df$violation.description))%>%
...
```{r export data}
save(df_word, file="~/Documents/Spring2020-Project2-group-12/output/df.word.RData")
```
