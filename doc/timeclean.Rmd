...
```{r}
# Load data
df_0 <- read.csv('/Users/meow/Documents/GitHub/Spring2020-Project2-group-12/data/DOHMH_New_York_City_Restaurant_Inspection_Results.csv')
```
...
```{r}
tt <- df.clean %>%
  filter(inspection_year != '2013' & inspection_year != '2014')%>%
...
```{r}
save(tt, file=".../output/timeTrend.RData")
```